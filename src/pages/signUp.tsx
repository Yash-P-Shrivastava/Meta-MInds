import { MdAndroid, MdLogin } from 'react-icons/md';
...
const MdLoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        setSuccessMessage(data.message); // Handle successful registration
      ...
      if (response1.ok) {
        setSuccessMessage(data1.message); // Handle successful registration
        setTimeout(() => {
          navigate('/main'); 
        }, 2000);
      }
      ...
      <div className="space-y-8">
        <div className="space-y-4">
          <h2 className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
            Sign in to MetaMinds
          </h2>
          <p className="text-gray-300 text-lg">
            Access AI-powered interview preparation tailored to your job role. Please sign up or log in to continue.
          </p>
